...
#include <string.h>
#include <conio.h>
const char POSTURL[45]="http://172.16.154.130:69/cgi-bin/srun_portal";  //定义POST地址  
...
{
	char username[20];
	char post[200] = "action:login&drop:0&pop:1&type:2&n:117&username:{SRUN3}\r\n";//学长抓包分析得到的头文件
	char password[20];
	char acid[8]="&acid:";
	unsigned int i;
	printf("+++++++++++++欢迎使用校园网登陆器C语言版+++++++++++++\n");
	printf("+++++++Made By CHN-STUDENT && MouYouLing V0.0.2+++++++\n\n"); 
	printf("请输入你要登录的用户名:");
	gets(username);
